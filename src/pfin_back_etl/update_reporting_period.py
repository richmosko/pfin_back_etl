...
with sqla.orm.Session(engine) as session:
    # 1. Fetch what's already in pfin.reporting_period for later comparison
    ...
    # 4. Find the common columns to populate in the reporting_period DB table
    print(f"Merging columns to (inner join) to limit what gets sent to DB...")
    t_sbase = Base.by_module.pfin.reporting_period
