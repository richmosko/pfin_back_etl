...
with sqla.orm.Session(engine) as session:
    ...
    # 3. Fetch the stock cash_flow_statement data from FMP
    print('\n' + '==== ' * 8)
    print(f"Fetching cash_flow_statement data from Financial Modeling Prep...")
    df_fmp = utils.fetch_fmp_list_df(fmp_client.cash_flow_statement, 'symbol',
    ...
    # 4. Find the common columns to populate in the cash_flow_statement DB table
    print('\n' + '==== ' * 8)
    ...
    # 5. Isolate new cash_flow_statement(s) to insert
    print('\n' + '==== ' * 8)
    ...
    # 6. Isolate existing cash_flow_statement(s) to update
    print('\n' + '==== ' * 8)
