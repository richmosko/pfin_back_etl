...
with sqla.orm.Session(engine) as session:
    ...
    # 4. Find the common columns to populate in the income_statement DB table
    print('\n' + '==== ' * 8)
    ...
    # 5. Isolate new income_statement(s) to insert
    print('\n' + '==== ' * 8)
    ...
    # 6. Isolate existing income_statement(s) to update
    print('\n' + '==== ' * 8)
